                ...
                <div className="flex flex-col lg:flex-row justify-center items-center gap-10 ">
                    ...
                    <div className='w-full lg:w-3/4'>
                        <div className='grid md:grid-cols-2 sm:grid-cols-2 grid-cols-1 items-start md:gap-12 gap-8  '>
                            <div className='bg-[##ffffff66] rounded-lg h-96 shadow-3xl p-8 items-center flex justify-center hover:translate-y-4 transition-all duration-500 hover:bg-slate-50 select-none'>
